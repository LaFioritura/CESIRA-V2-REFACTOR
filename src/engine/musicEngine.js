/**
 * CESIRA music engine constants and composition helpers.
 * Extracted from the monolithic app to keep the audio/composition domain isolated.
 */
...
export const MAX_STEPS=64,PAGE=16,SCHED=0.14,LOOK=20,UNDO=32;
...
export const parseNoteName=n=>{const m=String(n||'').match(/^([A-G](?:b|#)?)(-?\d+)$/);return m?{name:m[1],oct:Number(m[2])}:null;};
...
export const SOUND_PRESETS={
  ...
  drum:{
    tight_punch:{label:'TIGHT PUNCH',drumDecay:0.32,noiseMix:0.12,compress:0.18,drive:0.1,kickWeight:1.08,kickClick:0.34,kickPunch:1.1,snareSnap:1.02,hatBrightness:1.04,hatDecay:0.9},
    warehouse:{label:'WAREHOUSE',drumDecay:0.48,noiseMix:0.22,compress:0.28,drive:0.18,kickWeight:1.16,kickClick:0.2,kickPunch:0.94,snareSnap:0.92,snareTone:0.88,hatBrightness:0.94,hatDecay:1.18},
    broken_air:{label:'BROKEN AIR',drumDecay:0.58,noiseMix:0.34,compress:0.24,drive:0.12,swing:0.06,kickWeight:0.96,kickClick:0.28,kickPunch:1.02,snareSnap:1.08,snareTone:1.12,hatBrightness:1.1,hatDecay:0.82,hatOpenDecay:1.12},
    industrial_haze:{label:'INDUSTRIAL HAZE',drumDecay:0.64,noiseMix:0.42,compress:0.34,drive:0.28,kickWeight:1.22,kickClick:0.18,kickDrive:0.16,kickBodyType:'triangle',snareSnap:0.86,snareTone:0.82,hatBrightness:0.9,hatDecay:1.26},
    dusty_tape:{label:'DUSTY TAPE',drumDecay:0.44,noiseMix:0.28,compress:0.22,drive:0.16,tone:0.58,kickWeight:0.94,kickClick:0.16,kickPunch:0.92,snareSnap:0.88,snareTone:0.9,hatBrightness:0.88,hatDecay:1.14},
    crisp_club:{label:'CRISP CLUB',drumDecay:0.26,noiseMix:0.1,compress:0.26,drive:0.08,tone:0.68,kickWeight:1.02,kickClick:0.38,kickPunch:1.08,snareSnap:1.1,snareTone:1.08,hatBrightness:1.12,hatDecay:0.78},
    arena_thump:{label:'ARENA THUMP',drumDecay:0.54,noiseMix:0.16,compress:0.3,drive:0.14,kickWeight:1.28,kickClick:0.14,kickPunch:0.88,kickSub:1.18,snareSnap:0.94,hatBrightness:0.92,hatDecay:1.22},
    rubber_drive:{label:'RUBBER DRIVE',drumDecay:0.3,noiseMix:0.14,compress:0.2,drive:0.12,kickWeight:0.98,kickClick:0.42,kickPunch:1.18,snareSnap:1.0,snareTone:1.04,hatBrightness:1.08,hatDecay:0.84},
    night_pulse:{label:'NIGHT PULSE',drumDecay:0.38,noiseMix:0.2,compress:0.24,drive:0.1,kickWeight:1.06,kickClick:0.24,kickPunch:1.0,snareSnap:0.96,hatBrightness:1.0,hatDecay:0.96},
    brittle_break:{label:'BRITTLE BREAK',drumDecay:0.46,noiseMix:0.36,compress:0.28,drive:0.18,swing:0.04,kickWeight:0.92,kickClick:0.3,kickPunch:1.04,snareSnap:1.16,snareTone:1.16,hatBrightness:1.18,hatDecay:0.76,hatOpenDecay:0.96},
  },
  performance:{
